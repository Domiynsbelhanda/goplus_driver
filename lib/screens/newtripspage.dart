...
import 'package:taxigo_driver/helpers/mapkithelper.dart';
import 'package:taxigo_driver/widgets/CollectPaymentDialog.dart';
...
class _NewTripPageState extends State<NewTripPage> {
  ...
  void createMarker(){
    if(movingMarkerIcon == null){
      ...
      ImageConfiguration imageConfiguration = createLocalImageConfiguration(context, size: Size(1,2));
